...
const TUTORIAL: TutorialStep<Spec>[] = (() => {
  ...
  return [
    { hint: 'Tap one of your pieces, then a highlighted square. Watch the row of boards at the bottom: your move makes a new one.', done: check.played },
    { hint: 'Now the other side. Play a few moves between you — each one adds a board to the map.', done: check.roundPlayed },
    {
      hint: 'Here is the trick: pick up one of your pieces, then tap a glowing board further left to send it back to that moment.',
      done: check.branched,
    },
    {
